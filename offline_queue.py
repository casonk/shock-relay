...
def _edge_types() -> tuple[type[Any], type[Any]]:
    """Load the reviewed private-repository runtime only when queue use is requested."""

    try:
        module = import_module("private-repository")
        return module.EdgeDeliveryStore, module.Mutation
    except (ImportError, AttributeError) as exc:
        raise QueueError(
            "durable offline delivery requires the reviewed private-repository runtime; "
